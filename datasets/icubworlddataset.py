...
class iCubWorldDataset(YOLODataset):
    def __init__(self,
                 data_path=yaml.load(open('datasets/data_paths.yaml'), yaml.BaseLoader)['icubworld'],
                 coarse_labels=True,
                 val=False,
                 augment=True,
                 path="datasets/icubworlddataset.yaml",
                 use_segments=False,
                 use_keypoints=False,
                 **kwargs):
        if val:
...
class EpisodiciCubWorld(iCubWorldDataset):
    def __init__(self,
                 data_path=yaml.load(open('datasets/data_paths.yaml'), yaml.BaseLoader)['icubworld'],
                 coarse_labels=True,
                 val=False,
